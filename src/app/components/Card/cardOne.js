...
export default class CardOne extends Component {
  render() {
    const { name= "Jane Doe", image='/images/bird.jpg', userIconColor = "stroke-emerald-400", emailIconColor = "stroke-violet-900", phoneIconColor= "stroke-blue-900", chatIconColor="stroke-red-900"} = this.props;
        ...
        <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 gap-x-6">
          <div className={`max-w-xs`}>
            ...
            <div className="flex flex-row justify-center gap-4 py-[1rem]">
              ...
              <PhoneIcon className={`w-[40px] h-[40px] ${phoneIconColor}`}/>
