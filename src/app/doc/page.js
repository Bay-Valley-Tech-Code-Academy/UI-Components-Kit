          ...
          <section id="api-reference" className="p-4 border border-gray-300 rounded-lg bg-[#333044] shadow-md mt-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-[#ffffff] mt-4">
                <strong>More Details:</strong> <Link href="/components/Documentation/NavBarOneDetails" className="text-indigo-200 hover:text-orange-400">Learn more about NavbarOne</Link>
              </p>
            </div>
